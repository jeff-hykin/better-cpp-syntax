...
grammar.import(PathFor[:sharedPattern]["inline_comment"])
grammar.import(PathFor[:sharedPattern]["std_space"])
grammar.import(File.join(__dir__, "..", "cpp", "lib/preprocessor"))
...
#
    ...
    look_behind_for_type = lookBehindFor(Pattern.new(/[a-zA-Z_0-9] /).or(symbols_that_can_appear_after_a_type)).maybe(@spaces)
    array_brackets = Pattern.new(/\[\]/).maybe(@spaces)
    comma_or_closing_paraenthese = /[,)]/
...
c_grammar[:probably_a_parameter] = probably_a_parameter_1_group
c_grammar[:"access-method"] = {
...
c_grammar[:line_continuation_character] = {
    patterns: [
        {
            match: "(\\\\)\\n",
            captures: {
...
c_grammar[:vararg_ellipses] = {
    match: "(?<!\\.)\\.\\.\\.(?!\\.)",
    name: "punctuation.vararg-ellipses.c"
}
c_grammar[:"preprocessor-rule-conditional"] = {
    patterns: [
        {
            begin: "^\\s*((#)\\s*if(?:n?def)?\\b)",
            beginCaptures: {
...
c_grammar[:"preprocessor-rule-conditional-block"] = {
    patterns: [
        {
            begin: "^\\s*((#)\\s*if(?:n?def)?\\b)",
            beginCaptures: {
...
c_grammar[:"preprocessor-rule-conditional-line"] = {
    patterns: [
        {
...
c_grammar[:"preprocessor-rule-disabled"] = {
    patterns: [
        {
...
c_grammar[:"preprocessor-rule-disabled-block"] = {
    patterns: [
        {
            begin: "^\\s*((#)\\s*if\\b)(?=\\s*\\(*\\b0+\\b\\)*\\s*(?:$|//|/\\*))",
            beginCaptures: {
...
c_grammar[:"preprocessor-rule-disabled-elif"] = {
...
c_grammar[:"preprocessor-rule-enabled"] = {
    patterns: [
        {
...
c_grammar[:"preprocessor-rule-enabled-block"] = {
    patterns: [
        {
            begin: "^\\s*((#)\\s*if\\b)(?=\\s*\\(*\\b0*1\\b\\)*\\s*(?:$|//|/\\*))",
            beginCaptures: {
...
c_grammar[:"preprocessor-rule-enabled-elif"] = {
...
c_grammar[:"preprocessor-rule-enabled-elif-block"] = {
    begin: "^\\s*((#)\\s*elif\\b)(?=\\s*\\(*\\b0*1\\b\\)*\\s*(?:$|//|/\\*))",
    beginCaptures: {
        "0" => {
            name: "meta.preprocessor.c"
...
c_grammar[:"preprocessor-rule-enabled-else"] = {
    begin: "^\\s*((#)\\s*else\\b)",
    beginCaptures: {
        "0" => {
            name: "meta.preprocessor.c"
...
c_grammar[:"preprocessor-rule-enabled-else-block"] = {
    begin: "^\\s*((#)\\s*else\\b)",
    beginCaptures: {
        "0" => {
            name: "meta.preprocessor.c"
...
c_grammar[:"preprocessor-rule-define-line-contents"] = {
    patterns: [
        {
...
c_grammar[:"preprocessor-rule-define-line-blocks"] = {
    patterns: [
        {
            begin: "{",
            beginCaptures: {
...
c_grammar[:"preprocessor-rule-define-line-functions"] = {
    patterns: [
        {
            include: "#comments"
        },
...
c_grammar[:"function-call-innards"] = {
    patterns: [
        {
            include: "#comments"
        },
...
grammar.save_to(
    ...
    tag_dir: File.dirname(PathFor[:languageTag]["c"])
)
