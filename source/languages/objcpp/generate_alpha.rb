...
# 
# Modifications to the C++ grammar
# 
# add all the repos to objective_cpp_grammar
for each_key, each_value in @cpp_grammar.data[:repository]
    if @cpp_grammar[each_key].is_a?(Array) ||  @cpp_grammar[each_key].is_a?(Hash)
        objective_cpp_grammar[each_key] = @cpp_grammar[each_key].dup
    else
        objective_cpp_grammar[each_key] = @cpp_grammar[each_key].to_tag(ignore_repository_entry:true)
    end
end
...
objective_cpp_grammar[:objective_c] = {
    patterns: [
        {
    ...
    repository: {
        ...
        :comment => { "patterns" => [{ "begin" => "/\\*", "captures" => { "0" => { "name" => "punctuation.definition.comment" } }, "end" => "\\*/", "name" => "comment.block" }, { "begin" => "(^[ \\t]+)?(?=//)", "beginCaptures" => { "1" => { "name" => "punctuation.whitespace.comment.leading" } }, "end" => "(?!\\G)", "patterns" => [{ "begin" => "//", "beginCaptures" => { "0" => { "name" => "punctuation.definition.comment" } }, "end" => "\\n", "name" => "comment.line.double-slash", "patterns" => [{ "match" => "(?>\\\\\\s*\\n)", "name" => "punctuation.separator.continuation" }] }] }] },
        :disabled => { "begin" => "^\\s*#\\s*if(n?def)?\\b.*$", "comment" => "eat nested preprocessor if(def)s", "end" => "^\\s*#\\s*endif\\b.*$", "patterns" => [{ "include" => "#disabled" }, { "include" => "#pragma-mark" }] },
        :implementation_innards => { "patterns" => [{ "include" => "#preprocessor-rule-enabled-implementation" }, { "include" => "#preprocessor-rule-disabled-implementation" }, { "include" => "#preprocessor-rule-other-implementation" }, { "include" => "#property_directive" }, { "include" => "#special_variables" }, { "include" => "#method_super" }, { "include" => "$base" }] },
        :interface_innards => { "patterns" => [{ "include" => "#preprocessor-rule-enabled-interface" }, { "include" => "#preprocessor-rule-disabled-interface" }, { "include" => "#preprocessor-rule-other-interface" }, { "include" => "#properties" }, { "include" => "#protocol_list" }, { "include" => "#method" }, { "include" => "$base" }] },
        ...
        :method_super => { "begin" => "^(?=-|\\+)", "end" => "(?<=\\})|(?=#)", "name" => "meta.function-with-body", "patterns" => [{ "include" => "#method" }, { "include" => "$base" }] },
        :'pragma-mark' => { "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.pragma" }, "3" => { "name" => "meta.toc-list.pragma-mark" } }, "match" => "^\\s*(#\\s*(pragma\\s+mark)\\s+(.*))", "name" => "meta.section" },
        :'preprocessor-rule-disabled-implementation' => { "begin" => "^\\s*(#(if)\\s+(0)\\b).*", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.if" }, "3" => { "name" => "constant.numeric.preprocessor" } }, "end" => "^\\s*(#\\s*(endif)\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "begin" => "^\\s*(#\\s*(else)\\b)", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.else" } }, "end" => "(?=^\\s*#\\s*endif\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "include" => "#interface_innards" }] }, { "begin" => "", "end" => "(?=^\\s*#\\s*(else|endif)\\b.*?(?:(?=(?://|/\\*))|$))", "name" => "comment.block.preprocessor.if-branch", "patterns" => [{ "include" => "#disabled" }, { "include" => "#pragma-mark" }] }] },
        :'preprocessor-rule-disabled-interface' => { "begin" => "^\\s*(#(if)\\s+(0)\\b).*", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.if" }, "3" => { "name" => "constant.numeric.preprocessor" } }, "end" => "^\\s*(#\\s*(endif)\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "begin" => "^\\s*(#\\s*(else)\\b)", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.else" } }, "end" => "(?=^\\s*#\\s*endif\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "include" => "#interface_innards" }] }, { "begin" => "", "end" => "(?=^\\s*#\\s*(else|endif)\\b.*?(?:(?=(?://|/\\*))|$))", "name" => "comment.block.preprocessor.if-branch", "patterns" => [{ "include" => "#disabled" }, { "include" => "#pragma-mark" }] }] },
        :'preprocessor-rule-enabled-implementation' => { "begin" => "^\\s*(#(if)\\s+(0*1)\\b)", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.if" }, "3" => { "name" => "constant.numeric.preprocessor" } }, "end" => "^\\s*(#\\s*(endif)\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "begin" => "^\\s*(#\\s*(else)\\b).*", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.else" } }, "contentName" => "comment.block.preprocessor.else-branch", "end" => "(?=^\\s*#\\s*endif\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "include" => "#disabled" }, { "include" => "#pragma-mark" }] }, { "begin" => "", "end" => "(?=^\\s*#\\s*(else|endif)\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "include" => "#implementation_innards" }] }] },
        :'preprocessor-rule-enabled-interface' => { "begin" => "^\\s*(#(if)\\s+(0*1)\\b)", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.if" }, "3" => { "name" => "constant.numeric.preprocessor" } }, "end" => "^\\s*(#\\s*(endif)\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "begin" => "^\\s*(#\\s*(else)\\b).*", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import.else" } }, "contentName" => "comment.block.preprocessor.else-branch", "end" => "(?=^\\s*#\\s*endif\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "include" => "#disabled" }, { "include" => "#pragma-mark" }] }, { "begin" => "", "end" => "(?=^\\s*#\\s*(else|endif)\\b.*?(?:(?=(?://|/\\*))|$))", "patterns" => [{ "include" => "#interface_innards" }] }] },
        :'preprocessor-rule-other-implementation' => { "begin" => "^\\s*(#\\s*(if(n?def)?)\\b.*?(?:(?=(?://|/\\*))|$))", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import" } }, "end" => "^\\s*(#\\s*(endif)\\b).*?(?:(?=(?://|/\\*))|$)", "patterns" => [{ "include" => "#implementation_innards" }] },
        :'preprocessor-rule-other-interface' => { "begin" => "^\\s*(#\\s*(if(n?def)?)\\b.*?(?:(?=(?://|/\\*))|$))", "captures" => { "1" => { "name" => "meta.preprocessor" }, "2" => { "name" => "keyword.control.import" } }, "end" => "^\\s*(#\\s*(endif)\\b).*?(?:(?=(?://|/\\*))|$)", "patterns" => [{ "include" => "#interface_innards" }] },
        ...
        :property_directive => { "captures" => { "1" => { "name" => "punctuation.definition.keyword" } }, "match" => "(@)(dynamic|synthesize)\\b", "name" => "keyword.other.property.directive" },
        ...
        :protocol_type_qualifier => { "match" => "\\b(in|out|inout|oneway|bycopy|byref)\\b", "name" => "storage.modifier.protocol" },
        :special_variables => { "patterns" => [{ "match" => "\\b_cmd\\b", "name" => "variable.other.selector" }, { "match" => "\\b(self|super)\\b", "name" => "variable.language" }] },
    }
}
