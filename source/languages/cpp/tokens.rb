...
@generate_tokens = ->(grammar) do
    grammar[ :_scope_resolution               ] = Pattern.new( match: "::"                            , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_post_increment                 ] = Pattern.new( match: "++"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledLeftToRight, :postFixOperator ] )
    grammar[ :_post_decrement                 ] = Pattern.new( match: "--"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledLeftToRight, :postFixOperator ] )
    grammar[ :_function_call                  ] = Pattern.new( match: "()"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword,                         :evaledLeftToRight,                         ] )
    grammar[ :_subscript                      ] = Pattern.new( match: "[]"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword,                         :evaledLeftToRight,                         ] )
    grammar[ :_object_accessor                ] = Pattern.new( match: "."                             , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_pointer_accessor               ] = Pattern.new( match: "->"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_pre_increment                  ] = Pattern.new( match: "++"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_pre_decrement                  ] = Pattern.new( match: "--"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_plus                           ] = Pattern.new( match: "+"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_minus                          ] = Pattern.new( match: "-"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_logic_not                      ] = Pattern.new( match: "!"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator , :logicicalOperator ] )
    grammar[ :_logic_not_word                 ] = Pattern.new( keyword: "not"                         , adjectives: [ :operator,                                      :urnaryOperator, :evaledRightToLeft, :preFixOperator , :logicicalOperator, :operatorAlias ] )
    grammar[ :_bitwise_not                    ] = Pattern.new( match: "~"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_bitwise_not_word               ] = Pattern.new( keyword: "compl"                       , adjectives: [ :operator,                                      :urnaryOperator, :evaledRightToLeft, :preFixOperator , :operatorAlias] )
    grammar[ :_dereference                    ] = Pattern.new( match: "*"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_reference                      ] = Pattern.new( match: "&"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_sizeof                         ] = Pattern.new( keyword: "sizeof"                      , adjectives: [ :operator,                                      :urnaryOperator, :evaledRightToLeft, :preFixOperator, :functionLike ] )
    grammar[ :_variadic_sizeof                ] = Pattern.new( match: "sizeof..."                     , adjectives: [ :operator,                                      :urnaryOperator, :evaledRightToLeft, :preFixOperator, :functionLike ] )
    grammar[ :_new                            ] = Pattern.new( keyword: "new"                         , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_new_array                      ] = Pattern.new( match: "new[]"                         , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_delete                         ] = Pattern.new( keyword: "delete"                      , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_delete_array                   ] = Pattern.new( match: "delete[]"                      , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :urnaryOperator, :evaledRightToLeft, :preFixOperator ] )
    grammar[ :_object_accessor_dereference    ] = Pattern.new( match: ".*"                            , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_pointer_accessor_dereference   ] = Pattern.new( match: "->*"                           , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_multiplication                 ] = Pattern.new( match: "*"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_division                       ] = Pattern.new( match: "/"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_modulus                        ] = Pattern.new( match: "%"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_addition                       ] = Pattern.new( match: "+"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_subtraction                    ] = Pattern.new( match: "-"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_bitwise_shift_left_assignment  ] = Pattern.new( match: "<<="                           , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_bitwise_shift_right_assignment ] = Pattern.new( match: ">>="                           , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_bitwise_shift_left             ] = Pattern.new( match: "<<"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_bitwise_shift_right            ] = Pattern.new( match: ">>"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_three_way_compare              ] = Pattern.new( match: "<=>"                           , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :comparisonOperator] )
    grammar[ :_less_than                      ] = Pattern.new( match: "<"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :comparisonOperator] )
    grammar[ :_less_than_or_equal_to          ] = Pattern.new( match: "<="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :comparisonOperator] )
    grammar[ :_greater_than                   ] = Pattern.new( match: ">"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :comparisonOperator] )
    grammar[ :_greater_than_or_equal_to       ] = Pattern.new( match: ">="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :comparisonOperator] )
    grammar[ :_equal_to                       ] = Pattern.new( match: "=="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :comparisonOperator] )
    grammar[ :_not_equal_to                   ] = Pattern.new( match: "!="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :comparisonOperator] )
    grammar[ :_not_equal_to_word              ] = Pattern.new( keyword: "not_eq"                      , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator , :comparisonOperator, :operatorAlias,] )
    grammar[ :_bitwise_and                    ] = Pattern.new( match: "&"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_bitwise_and_word               ] = Pattern.new( keyword: "bitand"                      , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator , :operatorAlias] )
    grammar[ :_bitwise_xor                    ] = Pattern.new( match: "^"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_bitwise_xor_word               ] = Pattern.new( keyword: "xor"                         , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator , :operatorAlias] )
    grammar[ :_bitwise_or                     ] = Pattern.new( match: "|"                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator ] )
    grammar[ :_bitwise_or_word                ] = Pattern.new( keyword: "bitor"                       , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator , :operatorAlias] )
    grammar[ :_logical_and                    ] = Pattern.new( match: "&&"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :logicicalOperator] )
    grammar[ :_logical_and_word               ] = Pattern.new( keyword: "and"                         , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator , :logicicalOperator, :operatorAlias] )
    grammar[ :_logical_or                     ] = Pattern.new( match: "||"                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledLeftToRight, :inFixOperator , :logicicalOperator] )
    grammar[ :_logical_or_word                ] = Pattern.new( keyword: "or"                          , adjectives: [ :operator,                                      :binaryOperator, :evaledLeftToRight, :inFixOperator , :logicicalOperator, :operatorAlias] )
    grammar[ :_ternary_conditional            ] = Pattern.new( match: "?:"                            , adjectives: [ :operator,                                      :ternaryOperator, :evaledRightToLeft,                         ] )
    grammar[ :_throw                          ] = Pattern.new( keyword: "throw"                       , adjectives: [ :operator,                                      :urnaryOperator, :evaledRightToLeft, :preFixOperator , :controlFlow, :exceptionRelated] )
    grammar[ :_direct_assignment              ] = Pattern.new( match: "="                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_addition_assignment            ] = Pattern.new( match: "+="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_subtraction_assignment         ] = Pattern.new( match: "-="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_multiplication_assignment      ] = Pattern.new( match: "*="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_division_assignment            ] = Pattern.new( match: "/="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_modulus_assignment             ] = Pattern.new( match: "%="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_bitwise_and_assignment         ] = Pattern.new( match: "&="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_bitwise_and_assignment_word    ] = Pattern.new( keyword: "and_eq"                      , adjectives: [ :operator,                                      :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator , :operatorAlias] )
    grammar[ :_bitwise_xor_assignment         ] = Pattern.new( match: "^="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_bitwise_xor_assignment_word    ] = Pattern.new( keyword: "xor_eq"                      , adjectives: [ :operator,                                      :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator , :operatorAlias] )
    grammar[ :_bitwise_or_assignment          ] = Pattern.new( match: "|="                            , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator ] )
    grammar[ :_bitwise_or_assignment_word     ] = Pattern.new( keyword: "or_eq"                       , adjectives: [ :operator,                                      :binaryOperator, :evaledRightToLeft, :inFixOperator , :assignmentOperator , :operatorAlias] )
    grammar[ :_comma                          ] = Pattern.new( match: ","                             , adjectives: [ :operator, :canAppearAfterOperatorKeyword, :binaryOperator, :evaledRightToLeft, :inFixOperator ] )
    # no presedence
    grammar[ :_alignof                        ] = Pattern.new( keyword: "alignof"                     , adjectives: [ :operator,                                                                                                           :functionLike ] )
    grammar[ :_alignas                        ] = Pattern.new( keyword: "alignas"                     , adjectives: [ :operator,                                                                                                           :functionLike ] )
    grammar[ :_typeid                         ] = Pattern.new( keyword: "typeid"                      , adjectives: [ :operator,                                                                                                           :functionLike ] )
    grammar[ :_noexcept                       ] = Pattern.new( keyword: "noexcept"                    , adjectives: [ :operator ] )
    grammar[ :_noexcept                       ] = Pattern.new( keyword: "noexcept"                    , adjectives: [ :operator,  :functionLike ] )
    grammar[ :_static_cast                    ] = Pattern.new( keyword: "static_cast"                 , adjectives: [ :operator , :typeCastingOperator] )
    grammar[ :_dynamic_cast                   ] = Pattern.new( keyword: "dynamic_cast"                , adjectives: [ :operator , :typeCastingOperator] )
    grammar[ :_const_cast                     ] = Pattern.new( keyword: "const_cast"                  , adjectives: [ :operator , :typeCastingOperator] )
    grammar[ :_reinterpret_cast               ] = Pattern.new( keyword: "reinterpret_cast"            , adjectives: [ :operator , :typeCastingOperator] )
    # control
    ...
    grammar[ :_auto                           ] = Pattern.new( keyword: "auto"                        , adjectives: [ :primitive, :type] )
    grammar[ :_void                           ] = Pattern.new( keyword: "void"                        , adjectives: [ :primitive, :type] )
    grammar[ :_char                           ] = Pattern.new( keyword: "char"                        , adjectives: [ :primitive, :type] )
    grammar[ :_short                          ] = Pattern.new( keyword: "short"                       , adjectives: [ :primitive, :type, :typeSpecifier] )
    grammar[ :_int                            ] = Pattern.new( keyword: "int"                         , adjectives: [ :primitive, :type] )
    grammar[ :_signed                         ] = Pattern.new( keyword: "signed"                      , adjectives: [ :primitive, :type, :typeSpecifier] )
    grammar[ :_unsigned                       ] = Pattern.new( keyword: "unsigned"                    , adjectives: [ :primitive, :type, :typeSpecifier] )
    grammar[ :_long                           ] = Pattern.new( keyword: "long"                        , adjectives: [ :primitive, :type, :typeSpecifier] )
    grammar[ :_float                          ] = Pattern.new( keyword: "float"                       , adjectives: [ :primitive, :type] )
    grammar[ :_double                         ] = Pattern.new( keyword: "double"                      , adjectives: [ :primitive, :type] )
    grammar[ :_bool                           ] = Pattern.new( keyword: "bool"                        , adjectives: [ :primitive, :type] )
    grammar[ :_wchar_t                        ] = Pattern.new( keyword: "wchar_t"                     , adjectives: [ :primitive, :type] )
    # other types
    grammar[ :_u_char               ] = Pattern.new( keyword: "u_char"                      , adjectives: [ :type ] )
    grammar[ :_u_short              ] = Pattern.new( keyword: "u_short"                     , adjectives: [ :type ] )
    grammar[ :_u_int                ] = Pattern.new( keyword: "u_int"                       , adjectives: [ :type ] )
    grammar[ :_u_long               ] = Pattern.new( keyword: "u_long"                      , adjectives: [ :type ] )
    grammar[ :_ushort               ] = Pattern.new( keyword: "ushort"                      , adjectives: [ :type ] )
    grammar[ :_uint                 ] = Pattern.new( keyword: "uint"                        , adjectives: [ :type ] )
    grammar[ :_u_quad_t             ] = Pattern.new( keyword: "u_quad_t"                    , adjectives: [ :type ] )
    grammar[ :_quad_t               ] = Pattern.new( keyword: "quad_t"                      , adjectives: [ :type ] )
    grammar[ :_qaddr_t              ] = Pattern.new( keyword: "qaddr_t"                     , adjectives: [ :type ] )
    grammar[ :_caddr_t              ] = Pattern.new( keyword: "caddr_t"                     , adjectives: [ :type ] )
    grammar[ :_daddr_t              ] = Pattern.new( keyword: "daddr_t"                     , adjectives: [ :type ] )
    grammar[ :_div_t                ] = Pattern.new( keyword: "div_t"                       , adjectives: [ :type ] )
    grammar[ :_dev_t                ] = Pattern.new( keyword: "dev_t"                       , adjectives: [ :type ] )
    grammar[ :_fixpt_t              ] = Pattern.new( keyword: "fixpt_t"                     , adjectives: [ :type ] )
    grammar[ :_blkcnt_t             ] = Pattern.new( keyword: "blkcnt_t"                    , adjectives: [ :type ] )
    grammar[ :_blksize_t            ] = Pattern.new( keyword: "blksize_t"                   , adjectives: [ :type ] )
    grammar[ :_gid_t                ] = Pattern.new( keyword: "gid_t"                       , adjectives: [ :type ] )
    grammar[ :_in_addr_t            ] = Pattern.new( keyword: "in_addr_t"                   , adjectives: [ :type ] )
    grammar[ :_in_port_t            ] = Pattern.new( keyword: "in_port_t"                   , adjectives: [ :type ] )
    grammar[ :_ino_t                ] = Pattern.new( keyword: "ino_t"                       , adjectives: [ :type ] )
    grammar[ :_key_t                ] = Pattern.new( keyword: "key_t"                       , adjectives: [ :type ] )
    grammar[ :_mode_t               ] = Pattern.new( keyword: "mode_t"                      , adjectives: [ :type ] )
    grammar[ :_nlink_t              ] = Pattern.new( keyword: "nlink_t"                     , adjectives: [ :type ] )
    grammar[ :_id_t                 ] = Pattern.new( keyword: "id_t"                        , adjectives: [ :type ] )
    grammar[ :_pid_t                ] = Pattern.new( keyword: "pid_t"                       , adjectives: [ :type ] )
    grammar[ :_off_t                ] = Pattern.new( keyword: "off_t"                       , adjectives: [ :type ] )
    grammar[ :_segsz_t              ] = Pattern.new( keyword: "segsz_t"                     , adjectives: [ :type ] )
    grammar[ :_swblk_t              ] = Pattern.new( keyword: "swblk_t"                     , adjectives: [ :type ] )
    grammar[ :_uid_t                ] = Pattern.new( keyword: "uid_t"                       , adjectives: [ :type ] )
    grammar[ :_id_t                 ] = Pattern.new( keyword: "id_t"                        , adjectives: [ :type ] )
    grammar[ :_clock_t              ] = Pattern.new( keyword: "clock_t"                     , adjectives: [ :type ] )
    grammar[ :_size_t               ] = Pattern.new( keyword: "size_t"                      , adjectives: [ :type ] )
    grammar[ :_ssize_t              ] = Pattern.new( keyword: "ssize_t"                     , adjectives: [ :type ] )
    grammar[ :_time_t               ] = Pattern.new( keyword: "time_t"                      , adjectives: [ :type ] )
    grammar[ :_useconds_t           ] = Pattern.new( keyword: "useconds_t"                  , adjectives: [ :type ] )
    grammar[ :_suseconds_t          ] = Pattern.new( keyword: "suseconds_t"                 , adjectives: [ :type ] )
    grammar[ :_int8_t               ] = Pattern.new( keyword: "int8_t"                      , adjectives: [ :type ] )
    grammar[ :_int16_t              ] = Pattern.new( keyword: "int16_t"                     , adjectives: [ :type ] )
    grammar[ :_int32_t              ] = Pattern.new( keyword: "int32_t"                     , adjectives: [ :type ] )
    grammar[ :_int64_t              ] = Pattern.new( keyword: "int64_t"                     , adjectives: [ :type ] )
    grammar[ :_uint8_t              ] = Pattern.new( keyword: "uint8_t"                     , adjectives: [ :type ] )
    grammar[ :_uint16_t             ] = Pattern.new( keyword: "uint16_t"                    , adjectives: [ :type ] )
    grammar[ :_uint32_t             ] = Pattern.new( keyword: "uint32_t"                    , adjectives: [ :type ] )
    grammar[ :_uint64_t             ] = Pattern.new( keyword: "uint64_t"                    , adjectives: [ :type ] )
    grammar[ :_int_least8_t         ] = Pattern.new( keyword: "int_least8_t"                , adjectives: [ :type ] )
    grammar[ :_int_least16_t        ] = Pattern.new( keyword: "int_least16_t"               , adjectives: [ :type ] )
    grammar[ :_int_least32_t        ] = Pattern.new( keyword: "int_least32_t"               , adjectives: [ :type ] )
    grammar[ :_int_least64_t        ] = Pattern.new( keyword: "int_least64_t"               , adjectives: [ :type ] )
    grammar[ :_uint_least8_t        ] = Pattern.new( keyword: "uint_least8_t"               , adjectives: [ :type ] )
    grammar[ :_uint_least16_t       ] = Pattern.new( keyword: "uint_least16_t"              , adjectives: [ :type ] )
    grammar[ :_uint_least32_t       ] = Pattern.new( keyword: "uint_least32_t"              , adjectives: [ :type ] )
    grammar[ :_uint_least64_t       ] = Pattern.new( keyword: "uint_least64_t"              , adjectives: [ :type ] )
    grammar[ :_int_fast8_t          ] = Pattern.new( keyword: "int_fast8_t"                 , adjectives: [ :type ] )
    grammar[ :_int_fast16_t         ] = Pattern.new( keyword: "int_fast16_t"                , adjectives: [ :type ] )
    grammar[ :_int_fast32_t         ] = Pattern.new( keyword: "int_fast32_t"                , adjectives: [ :type ] )
    grammar[ :_int_fast64_t         ] = Pattern.new( keyword: "int_fast64_t"                , adjectives: [ :type ] )
    grammar[ :_uint_fast8_t         ] = Pattern.new( keyword: "uint_fast8_t"                , adjectives: [ :type ] )
    grammar[ :_uint_fast16_t        ] = Pattern.new( keyword: "uint_fast16_t"               , adjectives: [ :type ] )
    grammar[ :_uint_fast32_t        ] = Pattern.new( keyword: "uint_fast32_t"               , adjectives: [ :type ] )
    grammar[ :_uint_fast64_t        ] = Pattern.new( keyword: "uint_fast64_t"               , adjectives: [ :type ] )
    grammar[ :_intptr_t             ] = Pattern.new( keyword: "intptr_t"                    , adjectives: [ :type ] )
    grammar[ :_uintptr_t            ] = Pattern.new( keyword: "uintptr_t"                   , adjectives: [ :type ] )
    grammar[ :_intmax_t             ] = Pattern.new( keyword: "intmax_t"                    , adjectives: [ :type ] )
    grammar[ :_intmax_t             ] = Pattern.new( keyword: "intmax_t"                    , adjectives: [ :type ] )
    grammar[ :_uintmax_t            ] = Pattern.new( keyword: "uintmax_t"                   , adjectives: [ :type ] )
    grammar[ :_uintmax_t            ] = Pattern.new( keyword: "uintmax_t"                   , adjectives: [ :type ] )
    grammar[ :_uintmax_t            ] = Pattern.new( keyword: "uintmax_t"                   , adjectives: [ :type ] )
    # literals
    ...
    # type creators
    grammar[ :_class           ] = Pattern.new( keyword: "class"                       , adjectives: [ :typeCreator] )
    grammar[ :_struct          ] = Pattern.new( keyword: "struct"                      , adjectives: [ :typeCreator] )
    grammar[ :_union           ] = Pattern.new( keyword: "union"                       , adjectives: [ :typeCreator] )
    grammar[ :_enum            ] = Pattern.new( keyword: "enum"                        , adjectives: [ :typeCreator] )
    # storage specifiers https://en.cppreference.com/w/cpp/language/declarations 
    grammar[ :_const            ] = Pattern.new( keyword: "const"                       , adjectives: [ :specifier, :storageSpecifier ] )
    grammar[ :_static           ] = Pattern.new( keyword: "static"                      , adjectives: [ :specifier, :storageSpecifier ] )
    grammar[ :_volatile         ] = Pattern.new( keyword: "volatile"                    , adjectives: [ :specifier, :storageSpecifier ] )
    grammar[ :_register         ] = Pattern.new( keyword: "register"                    , adjectives: [ :specifier, :storageSpecifier ] )
    grammar[ :_restrict         ] = Pattern.new( keyword: "restrict"                    , adjectives: [ :specifier, :storageSpecifier ] )
    grammar[ :_extern           ] = Pattern.new( keyword: "extern"                      , adjectives: [ :specifier, :storageSpecifier, :classSpecifier ] )
    # function specifiers/qualifiers
    grammar[ :_inline           ] = Pattern.new( keyword: "inline"                      , adjectives: [ :specifier , :functionSpecifier] )
    grammar[ :_constexpr        ] = Pattern.new( keyword: "constexpr"                   , adjectives: [ :specifier , :functionSpecifier] )
    grammar[ :_mutable          ] = Pattern.new( keyword: "mutable"                     , adjectives: [ :specifier , :functionSpecifier] )
    grammar[ :_friend           ] = Pattern.new( keyword: "friend"                      , adjectives: [ :specifier , :functionSpecifier] )
    grammar[ :_explicit         ] = Pattern.new( keyword: "explicit"                    , adjectives: [ :specifier , :functionSpecifier] )
    grammar[ :_virtual          ] = Pattern.new( keyword: "virtual"                     , adjectives: [ :specifier , :functionSpecifier, :inheritanceSpecifier ] )
    ...
    grammar[ :_noexcept         ] = Pattern.new( keyword: "noexcept"                    , adjectives: [ :specifier ,      :canAppearAfterParametersBeforeBody ] )
    # if statement specifiers see https://en.cppreference.com/w/cpp/language/if
    grammar[ :_constexpr        ] = Pattern.new( keyword: "constexpr"                   , adjectives: [ :specifier , :ifStatementSpecifier ] )
    # lambda specifiers
    grammar[ :_mutable            ] = Pattern.new( keyword: "mutable"                       , adjectives: [ :lambdaSpecifier ] )
    grammar[ :_constexpr          ] = Pattern.new( keyword: "constexpr"                     , adjectives: [ :lambdaSpecifier ] )
    ...
    grammar[ :_if                     ] = Pattern.new( keyword: "if"                           , adjectives: [ :preprocessorDirective ] )
    grammar[ :_elif                   ] = Pattern.new( keyword: "elif"                         , adjectives: [ :preprocessorDirective ] )
    grammar[ :_else                   ] = Pattern.new( keyword: "else"                         , adjectives: [ :preprocessorDirective ] )
    grammar[ :_endif                  ] = Pattern.new( keyword: "endif"                        , adjectives: [ :preprocessorDirective ] )
    grammar[ :_ifdef                  ] = Pattern.new( keyword: "ifdef"                        , adjectives: [ :preprocessorDirective ] )
    grammar[ :_ifndef                 ] = Pattern.new( keyword: "ifndef"                       , adjectives: [ :preprocessorDirective ] )
    grammar[ :_define                 ] = Pattern.new( keyword: "define"                       , adjectives: [ :preprocessorDirective ] )
    grammar[ :_undef                  ] = Pattern.new( keyword: "undef"                        , adjectives: [ :preprocessorDirective ] )
    grammar[ :_include                ] = Pattern.new( keyword: "include"                      , adjectives: [ :preprocessorDirective ] )
    grammar[ :_line                   ] = Pattern.new( keyword: "line"                         , adjectives: [ :preprocessorDirective ] )
    grammar[ :_error                  ] = Pattern.new( keyword: "error"                        , adjectives: [ :preprocessorDirective ] )
    grammar[ :_warning                ] = Pattern.new( keyword: "warning"                      , adjectives: [ :preprocessorDirective ] )
    grammar[ :_pragma                 ] = Pattern.new( keyword: "pragma"                       , adjectives: [ :preprocessorDirective ] )
    grammar[ :_pragma                 ] = Pattern.new( keyword: "_Pragma"                      , adjectives: [ :preprocessorDirective ] )
    grammar[ :_defined                ] = Pattern.new( keyword: "defined"                      , adjectives: [ :preprocessorDirective ] )
    grammar[ :___has_include          ] = Pattern.new( keyword: "__has_include"                , adjectives: [ :preprocessorDirective ] )
    grammar[ :___has_cpp_attribute    ] = Pattern.new( keyword: "__has_cpp_attribute"          , adjectives: [ :preprocessorDirective ] )
    ...
    grammar[ :_decltype      ] = Pattern.new( keyword: "decltype"               , adjectives: [ :specifier,  :functionLike ] )
