...
tokens = [
    ...
    { representation: "<"                    , name: "less-than"                      , isOperator: true, isBinaryOperator:  true, presedence:  9.1 , evaledLeftToRight: true, isInFixOperator:   true , isComparisionOperator: true},
    { representation: "<="                   , name: "less-than-or-equal-to"          , isOperator: true, isBinaryOperator:  true, presedence:  9.1 , evaledLeftToRight: true, isInFixOperator:   true , isComparisionOperator: true},
    { representation: ">"                    , name: "greater-than"                   , isOperator: true, isBinaryOperator:  true, presedence:  9.2 , evaledLeftToRight: true, isInFixOperator:   true , isComparisionOperator: true},
    { representation: ">="                   , name: "greater-than-or-equal-to"       , isOperator: true, isBinaryOperator:  true, presedence:  9.2 , evaledLeftToRight: true, isInFixOperator:   true , isComparisionOperator: true},
    { representation: "=="                   , name: "equal-to"                       , isOperator: true, isBinaryOperator:  true, presedence: 10   , evaledLeftToRight: true, isInFixOperator:   true , isComparisionOperator: true},
    { representation: "!="                   , name: "not-equal-to"                   , isOperator: true, isBinaryOperator:  true, presedence: 10   , evaledLeftToRight: true, isInFixOperator:   true , isComparisionOperator: true},
