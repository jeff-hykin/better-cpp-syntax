...
- Mac/Linux users
    ...
    - Type this inside your terminal/console <br>`repo=https://github.com/jeff-hykin/better-cpp-syntax eval "$(curl -fsSL git.io/JE2Zm || wget -qO- git.io/JE2Zm)"`<br>[press enter]
    - Possible errors:
