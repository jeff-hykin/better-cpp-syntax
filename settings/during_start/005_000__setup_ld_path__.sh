...
export LD_LIBRARY_PATH="$("$__PROJECTR_NIX_COMMANDS/lib_path_for" libglvnd):$LD_LIBRARY_PATH"
export LD_LIBRARY_PATH="$("$__PROJECTR_NIX_COMMANDS/lib_path_for" glib):$LD_LIBRARY_PATH"